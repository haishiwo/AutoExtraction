...
import extraction.monitor.RegexButtonMonitor;

public class RegexWindow extends JFrame {

	private JTextField regexText;// 主界面的regex文本框

	private String flag;// 对main和update的调用进行区别
	...
	public void setRegexText(JTextField regexText) {
	...
	public RegexWindow(JTextField field, String flag) {
		this.regexText = field;
		this.flag = flag;
	}
	...
	public void launchRegexWindow() {
		this.setLayout(new FlowLayout());
		this.setTitle("自定义开始行的识别规则");
		this.setSize(1150, 300);
		this.setResizable(false);
		this.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
		this.setLocationRelativeTo(null);
		this.setIconImage(new ImageIcon(RegexWindow.class.getResource("talk2.jpg")).getImage());
		...
		RegexButtonMonitor buttonMonitor = new RegexButtonMonitor(this);
	...
	// RegexWindow lw = new RegexWindow();
	// lw.launchRegexWindow();
	// }
